...
const BlogSchema = new mongoose.Schema({
  ...
  metaDescription: {
    type: String,
    trim: true,
    required: [true, "Meta Description name is required"],
    maxlength: [500, "Meta description cannot exceed 500 characters"], // Adding the metaDescription field with validation
  },
});
